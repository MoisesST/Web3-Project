  ...
  <div class="m-2 rounded">
    <div class="flex justify-around mb-6 py-6 text-black bg-violet-500 rounded">
      <div class="flex items-center">
        ...
        <span class="mx-2 font-bold uppercase text-sm">
          Registered Cities :
        </span>
    ...
    <div class="flex justify-around py-6 bg-violet-500 rounded">
      <div
        title="Total Rolês Rated 5 Stars"
      ...
      <div
        title="Total Rolês Rated 4 Stars"
        class="text-2xl text-black font-bold"
      >
        <i class="fa-solid fa-star"></i>
        <span class="">4 :</span>
      ...
      <div
        title="Total Rolês Rated 3 Stars"
        class="text-2xl text-black font-bold"
      >
        <i class="fa-solid fa-star"></i>
        <span class="">3 :</span>
      ...
      <div
        title="Total Rolês Rated 2 Stars"
        class="text-2xl text-black font-bold"
      >
        <i class="fa-solid fa-star"></i>
        <span class="">2 :</span>
      ...
      <div
        title="Total Rolês Rated 1 Stars"
        class="text-2xl text-black font-bold"
      >
        <i class="fa-solid fa-star"></i>
        <span class="">1 :</span>
      ...
      <div
        title="Total Rolês Rated 0 Stars"
        class="text-2xl text-black font-bold"
      >
        <i class="fa-solid fa-star"></i>
        <span class="">0 :</span>
